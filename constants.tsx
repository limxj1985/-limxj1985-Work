...
export const AGENDA_DATA: AgendaItem[] = [
  ...
  { 
    ...
    type: "general",
    details: [
      "National Anthem 'Negaraku', KKM & HRPB Songs",
      "Doa Recital",
      "Welcoming Speech by Dr. Fakhruddin Bin Amran (Director of HRPB)",
      "Officiating Speech by Dato' Dr. Feisul Idzwan bin Dato' Mustapha (Director of JKN Perak)",
  ...
  { 
    ...
    type: "session",
    details: [
      "Plenary 1: Prof. Dr. Rukman Bin Awang Hamat (Universiti Putra Malaysia)",
      "Plenary 2: Prof. Datin Dr. Sarinder Kaur Dhillon (Universiti Malaya)",
      "Plenary 3: Dr. Akhmal Yusof (Clinical Research Malaysia)"
    ]
  },
  { 
    time: "10:20 - 11:35", 
